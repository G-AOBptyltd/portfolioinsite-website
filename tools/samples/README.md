...
| `forecastinsite-fc-setup-workbook.xlsx` | Financial Controller onboarding workbook: Read Me + importable Features sheet (save as CSV to import) + gathering sheets for Teams/rates, Budgets, and Licences that are entered in-tool |
